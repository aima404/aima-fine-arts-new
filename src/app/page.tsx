...
export default function Home() {
  return (
    <div className="overflow-y-scroll h-full snap-y snap-mandatory">
      ...
      <section id="landing-page" className="snap-start min-h-screen">
        <LandingPage />
      </section>
      
      
      <section id="photo-gallery" className="snap-start min-h-screen">
        <MotionWrapperPage>
      ...
      <section id="bio" className="snap-start min-h-screen">
        <MotionWrapperPage>
      ...
      <section id="reviews" className="snap-start min-h-screen">
      <MotionWrapperPage>
        <Reviews />
      </MotionWrapperPage>
      </section>
